...
function getAdj(x){
  ...
  }; //corrected var scientific to scientific_default
};
...
function getNoun(y) {
  ...
  };  //corrected scifi to scifi_default
};
...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImage.src = "images/pizza.png"; //changed to .png file , smaller image file
...
var resizePizzas = function(size) { 
  ...
  // moved a few variables out of function loop
   var randomPizzas = document.getElementsByClassName("randomPizzaContainer"); 
   var dx = determineDx(randomPizzas[0], size); 
   var newwidth = (randomPizzas[0].offsetWidth + dx) + 'px'; 
   var pizzaS = randomPizzas.length 
  // created new variable pizzaS
...
// Moved resize animation around for better performance
// This for-loop actually creates and appends all of the pizzas when the page loads
  var pizzasDiv = document.getElementById("randomPizzas"); //replaced querrySelector with getElementById
  window.requestAnimationFrame(function(){
// Was suggested to remove requestAnimationFrame.. but dont know what to replace it with.. 
// Tried just making function addPizzas() instead, but did not work on my device..
  for (var i = 2; i < 100; i++) {
...
function updatePositions() {
  ...
  //everytime i replace with getElementByClassName, 
  // i get undefined error... so left querryselectorAll
  // optimized function and removed a few items from loop
...
// runs updatePositions on scroll, replaced old scroll tracer
 ...
 document.addEventListener('DOMContentLoaded', window.requestAnimationFrame(function() {
  ...
  // changed and optimized function var i start at 30 instead of 0
  for (var i = 30; i--;) {
